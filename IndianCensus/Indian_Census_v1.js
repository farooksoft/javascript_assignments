...
//1. Age-wise population distribution in terms of literate population
          ...
          if (field['Total/ Rural/ Urban'] == 1 && field['Age-group'] !== 'All ages' && field['Age-group'] !== '0-6') {
            var literate_population = parseInt(field['Literate - Persons']);
            if (field['Age-group'] in age_wise_data)
            {
              data_age = field['Age-group'];
